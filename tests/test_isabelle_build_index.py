...
from edel.isabelle import build_index
...
def test_build_index_main(tmp_path, monkeypatch):
    ...
    # Mocking functions
    monkeypatch.setattr(build_index, "ingest_session_lemmas", lambda **kwargs: mock_df)
    monkeypatch.setattr(build_index, "run_embedding_stage", lambda df, config: mock_df_embedded)
