                ...
                dbc.Card([
                    ...
                    dbc.CardBody([
                        html.Div([
                            ...
                            html.P("Tests if real science is structured differently from independent role-shuffling using two-sample KS tests.", className="small text-muted"),
                            
                            html.H6("H2: Local Transition Organization", className="text-primary mt-3"),
                            html.P("Tests if local neighborhood movements are significantly more clustered (lower Wasserstein distance) than permuted targets.", className="small text-muted"),
